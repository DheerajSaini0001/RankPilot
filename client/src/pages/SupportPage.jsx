        ...
        <DashboardLayout title="Support">
            <div className="max-w-4xl mx-auto px-4 py-12 space-y-12">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-neutral-500">Find answers or contact our team</p>
                </div>
                ...
                <div className="max-w-lg mx-auto relative group">
                    ...
                    <input 
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-white border border-neutral-200 rounded-xl focus:ring-1 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all text-sm shadow-sm"
                    />
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white border border-neutral-200 rounded-xl overflow-hidden divide-y divide-neutral-200 shadow-sm">
                ...
                <div className="bg-white border border-neutral-200 rounded-xl p-8 shadow-sm">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-neutral-900">Submit a Ticket</h2>
                    </div>
                    ...
                    {showSuccess ? (
                        ...
                        <form onSubmit={handleSubmitTicket} className="space-y-5">
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-neutral-700 ml-1">Subject</label>
                                <input 
                                    required
                                    type="text" 
                                    name="subject"
                                    ...
                                    className="w-full px-4 py-2.5 bg-white border border-neutral-200 rounded-lg focus:ring-1 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all text-sm"
                                />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-neutral-700 ml-1">Message</label>
                                <textarea 
                                    required
                                    rows="4"
                                    name="message"
                                    ...
                                    className="w-full px-4 py-2.5 bg-white border border-neutral-200 rounded-lg focus:ring-1 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all text-sm resize-none"
                                ></textarea>
                            </div>
                            <button 
                                disabled={isSubmitting}
                                type="submit"
                                className="px-8 py-2.5 bg-brand-500 text-white rounded-lg font-bold text-sm hover:bg-brand-600 transition-all disabled:opacity-50"
                            >
