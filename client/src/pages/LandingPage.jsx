            ...
            <nav className="sticky top-0 z-50 border-b border-neutral-200 dark:border-white/5">
                ...
                <div className="relative max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <NavLink to="/login" className="text-xs sm:text-sm font-bold text-neutral-500 dark:text-slate-400 hover:text-brand-600 dark:hover:text-white transition-colors px-2 sm:px-4 py-2">
                            Log in
                        </NavLink>
                        <NavLink to="/register"
