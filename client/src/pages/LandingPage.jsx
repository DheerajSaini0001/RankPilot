...
const LandingPage = () => {
    return (
        <div className="min-h-screen bg-slate-950 font-sans selection:bg-brand-500/30 selection:text-brand-200">
            ...
            <nav className="sticky top-0 z-50 border-b border-white/5">
                ...
                <div className="relative max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-lg font-black text-white tracking-tight">RankPilot<span className="text-brand-500">.</span></span>
                    </div>
            ...
            {/* 2. HERO SECTION — full-screen dramatic */}
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 px-6 py-24">
            ...
            {/* 3. INTEGRATION LOGOS STRIP — dark background */}
            <section className="bg-slate-900 border-y border-white/5 py-10 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    <p className="text-center text-xs font-black uppercase tracking-widest text-slate-500 mb-8">Natively connects with</p>
                    <div className="flex flex-wrap justify-center gap-4">
                        {[
                            ...
                            <div key={tool.name}
                                className="flex items-center gap-2.5 px-5 py-3 bg-white/5 hover:bg-white/8 border border-white/10 rounded-xl text-slate-300 text-sm font-bold transition-colors">
            ...
            <section id="features" className="py-28 bg-slate-950">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="text-center mb-20">
                        <p className="text-brand-500 font-bold text-xs tracking-[0.3em] uppercase mb-4">The Platform</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i}
                                className="group bg-slate-900 border border-white/8 rounded-3xl p-8 hover:border-brand-500/30 hover:bg-slate-800/50 transition-all duration-300 hover:-translate-y-1">
            ...
            <section id="how-it-works" className="py-28 bg-slate-900">
                <div className="max-w-5xl mx-auto px-6 text-center">
                    <p className="text-brand-500 font-bold text-xs tracking-[0.3em] uppercase mb-4">How It Works</p>
                    <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight mb-16">Up and running in minutes.</h2>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-14">
                        ...
                        <div className="col-span-2 md:col-span-1">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <span className="text-base font-black text-white">RankPilot<span className="text-brand-500">.</span></span>
                            </div>
                        ...
                        {/* Product */}
                        <div>
                            <h5 className="text-xs font-black text-white uppercase tracking-widest mb-4">Product</h5>
                            <ul className="space-y-3">
                                {['Features','Pricing','Integrations'].map(l => (
                                    <li key={l}><a href="#" className="text-xs font-semibold text-slate-500 hover:text-white transition-colors">{l}</a></li>
                                ))}
                            </ul>
                        </div>
