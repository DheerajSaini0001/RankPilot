            ...
            <div className="w-full max-w-5xl mx-auto space-y-8 pb-12">
                ...
                {loading ? (
                    ...
                    <div className="space-y-6">
                        {savingMsg && (
                            <div className="bg-brand-50 dark:bg-brand-900/20 text-brand-700 dark:text-brand-400 p-3 rounded-lg border border-brand-200 dark:border-brand-800 flex items-center mb-4 transition-all animate-in fade-in slide-in-from-top-1">
                                <svg className="animate-spin -ml-1 mr-3 h-4 w-4 text-brand-700 dark:text-brand-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
