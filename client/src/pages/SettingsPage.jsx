                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col p-5 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl border border-neutral-200 dark:border-neutral-700 hover:border-neutral-300 dark:hover:border-neutral-600 transition-all">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <p className="text-sm font-black text-neutral-900 dark:text-white">Google Platforms</p>
                                    <p className="text-xs text-neutral-400 font-medium">GA4 · Search Console · Ads</p>
                                </div>
                        ...
                        <div className="flex flex-col p-5 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl border border-neutral-200 dark:border-neutral-700 hover:border-neutral-300 dark:hover:border-neutral-600 transition-all">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <p className="text-sm font-black text-neutral-900 dark:text-white">Meta Business</p>
                                    <p className="text-xs text-neutral-400 font-medium">Facebook · Instagram Ads</p>
                                </div>
                                <div className="ml-auto">
